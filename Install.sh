...
echo -e "\033[1;35mVirtualbox kernal modules installed.\033[0m"
...
VBoxClient --vmsvga
echo -e "\033[1;35mclipboard, draganddrop, seamless, checkhostversion, vmsvga client features enabled.\033[0m"
